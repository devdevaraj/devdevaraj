...
#  print_header "${C_USER}devaraj@dev" "devaraj@dev"
    echo -e "${C_RED}root@devaraj${C_RESET}:${C_GREEN}~${C_RESET}# mefetch"
    print_header "${C_DASH}-${C_RESET} ${C_TITLE}Info" "- Info"
    ...
    print_row "Shell:" "bash, zsh"
    echo ""

    print_header "${C_DASH}-${C_RESET} ${C_TITLE}Development" "- Development"
    print_row "Languages.Programming:" "Golang, Python, Rust, TypeScript, Java, dart, bash"
    print_row "Languages.Other:" "HTML, CSS, JSON, TOML, YAML"
    print_row "FrameworksAndLibs:" "ExpressJS, ReactJS, NextJS, Android, Flutter"
    print_row "Databases:" "MongoDB, PostgreSQL, MySQL, Redis"
    print_row "Runtimes:" "NodeJS, JRE, WASM"
    print_row "Tools&Tech:" "Git, Github, Postman, Posthog, Grafana"
    print_row "Virtualization:" "Docker, Firecracker, VirtualBox"
    echo ""

    print_header "${C_DASH}-${C_RESET} ${C_TITLE}Research" "- Research"
    print_row "Interests:" "AI, Cybersecurity, Cloud, DevOps"
    print_row "Currently.Learning:" "Kubernetes, Offensive Security, LLMs"
    print_row "Currently.Building:" "SmartSpace, BTB, MongoBash"
    print_row "Dream.Projects:" "Self-hosted Cloud Infrastructure"
    echo ""
